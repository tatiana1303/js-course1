...
function showCategory(category) {
    ...
    let productsCategoryContent = '';
    productsCategory.forEach(function(product){
        productsCategoryContent += getProductMarkup(product);
    })
    product.insertAdjacentHTML('afterbegin', productsCategoryContent);
}
...
function getProductMarkup(product) {
    ...
    <a href="https://example.com/producs/${products.id}">Подробнее</a>
</div>`
}
